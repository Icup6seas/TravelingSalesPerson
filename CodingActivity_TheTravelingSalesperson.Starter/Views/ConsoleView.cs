...
namespace CodingActivity_TheTravelingSalesperson
{
    ...
    public class ConsoleView
    {
        ...
        public void DisplaySetupAccount()
        {
            ...
            int numberInStock = int.Parse(Console.ReadLine());
            _salesperson.Item.AddWidgets(numberInStock);
            Console.WriteLine();


            ConsoleUtil.DisplayPromptMessage("Enter your Account ID: ");
            _salesperson.AccountID = Convert.ToInt32(Console.ReadLine());
        ...
        public MenuOption DisplayGetUserMenuChoice()
        {
            ...
            while (usingMenu)
            {
                ...
                Console.WriteLine(
                    ...
                    "\t" + "4. Display Inventory Menu" + Environment.NewLine +
                    "\t" + "5. Display Cities Traveled" + Environment.NewLine +
                ...
                switch (userResponse.KeyChar)
                {
                    case '1':
                        ...
                        break;
                    case '4':
                        userMenuChoice = MenuOption.DisplayInvetoryMenu;
                        usingMenu = false;
                        break;
                    case '5':
        ...
        public string DisplayGetNextCity()
        {
            ...
            ConsoleUtil.DisplayPromptMessage("Enter the city you are currently in: ");
        ...
        public void DisplayInventory()
        {
            ...
            foreach (string type in _salesperson.ItemsInStock)
            {
                ConsoleUtil.DisplayMessage(type);
            }
        ...
        public void DisplayAccountInfo()
        {
            ...
            ConsoleUtil.DisplayMessage("Item Type: " + _salesperson.Item);
